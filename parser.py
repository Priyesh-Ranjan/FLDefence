...
def parse_args():
    ...
    parser.add_argument("--backdoor",nargs='?',type=str,choices=["central","intra","inter"], default=None)
    parser.add_argument("--label_flipping",nargs='?',type=str,choices=["uni","bi"], default=None)
